...
\usepackage[sfdefault]{roboto} % Using Roboto as the primary sans-serif font
...
% Font size control - you can adjust these values
\newcommand{\sectionfontsize}{\Large} % Section headers font size
\newcommand{\subsectionfontsize}{\normalsize} % Subsection font size
\newcommand{\bodyfontsize}{\small} % Main content font size
\newcommand{\headerfontsize}{\huge} % Header name font size
\newcommand{\summaryfontsize}{\small} % Summary text font size
...
\titleformat{\subsection}{\subsectionfontsize\bfseries\color{headercolor}}{\thesubsection}{1em}{}
\titlespacing*{\subsection}{0pt}{5pt}{4pt}

% Setting up itemize for consistent spacing
\setlist[itemize]{leftmargin=*,itemsep=0.3em,topsep=0.3em,font=\bodyfontsize}
