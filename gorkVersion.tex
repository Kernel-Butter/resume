...
\newcommand{\resumeHeader}[5]{ % Add 5th argument for summary
    \begin{center}
        \vspace*{10pt}
...
% \item \textbf{Animation Performance:} Optimized React.js animations using JavaScript and requestAnimationFrame, reducing rendering times by 25\% for seamless UI interactions
